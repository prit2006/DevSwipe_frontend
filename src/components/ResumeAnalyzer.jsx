...
const OrbLoader = () => (
  <div style={{ position:"relative", width:80, height:80 }}>
    ...
    <div style={{ position:"absolute", top:"50%", left:"50%", transform:"translate(-50%,-50%)", width:14, height:14, borderRadius:"50%", background:"radial-gradient(circle, #e879f9 0%, #7c3aed 100%)", boxShadow:"0 0 20px rgba(232,121,249,0.8)", animation:"aiPulse 2s ease-in-out infinite" }}/>
  </div>
);
...
const AILoadingScreen = () => {
  ...
  // cycle steps for visual feedback
  useEffect(() => {
    ...
    <div style={{ minHeight:"100vh", background:"#030308", position:"relative", display:"flex", alignItems:"center", justifyContent:"center" }}>
      ...
      <div style={{ position:"relative", zIndex:10, display:"flex", flexDirection:"column", alignItems:"center", gap:32, maxWidth:400, padding:"0 24px", textAlign:"center" }}>
        ...
        <div>
          ...
          <h2 className="ra-grad-title" style={{ fontFamily:"'Playfair Display', serif", fontSize:26, fontWeight:900, marginBottom:0 }}>
...
const ResumeAnalyzer = () => {
  ...
  // Show animated loading screen during AI analysis
